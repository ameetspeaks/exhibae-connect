# PowerShell script to test email sending using port 587 (TLS)

# SMTP Configuration
$smtpServer = "smtp.hostinger.com"
$smtpPort = 587  # Using port 587 with TLS instead of 465 with SSL
...
# Main script
Write-Host "===== EXHIBAE EMAIL TEST (Port 587) =====" -ForegroundColor Cyan
Write-Host "This script will test sending an email using port 587 with TLS."
...
$subject = "Test Email from ExhiBae (Port 587)"
$body = @"
<html>
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h1 style="color: #333; text-align: center;">ExhiBae Connect</h1>
    <p>$greeting</p>
    <p>This is a test email from ExhiBae Connect using port 587 with TLS. We're testing our new email system to ensure you receive important notifications.</p>
...
try {
    ...
    Write-Host "2. Verify that port 587 is not blocked by your firewall"
